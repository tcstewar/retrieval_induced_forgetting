...
class RIFModelFreq(object):
    def __init__(self, mapping, D_category=16, D_items=16, threshold=0.4, learning_rate=1e-4):
        model = spa.SPA()
        self.model = model
        ...
        with model:
            ...
            model.items = spa.State(D_items, vocab=self.vocab_items,subdimensions=64)
